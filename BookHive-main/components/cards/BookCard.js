	...
	return (
		<div className='flex items-center  justify-center w-full h-full xl:my-2 rounded-md group-hover:flex select-none'>
			<Link href={`/books/${book.slug}`}>
				<div className='relative flex bg-gradient-to-b from-blue-500 to-purple-500 flex-col w-28 h-52 xl:w-40 xl:h-72 rounded-md p-[0.1rem] xl:p-[0.2rem] bg-[#192132] xl:hover:bg-slate-800 xl:hover:scale-105 transform duration-100'>
